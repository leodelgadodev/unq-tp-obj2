...
class TestInmueble {
	...
	Inmueble i = new Inmueble("Casa","BsAs","Argentina","Roque Saenz Pe�a 352", servicios, 4,LocalDate.parse("2020-01-01"),LocalDate.parse("2020-01-30"),LocalTime.parse("08:00"),LocalTime.parse("22:00"),7000.00);
	...
	public void testLocacionDeInmueble() {
		...
		assertEquals( "Roque Saenz Pe�a 352", i.getDireccion());
	}
